...
$$
I_h(x) = \frac {(2x + x_{k+1} - 3x_k) (x - x_{k+1})^2} {(x_{k+1} - x_k)^3} f_k + \frac {(2x + x_k - 3x_{k+1}) (x - x_k)^2} {(x_k - x_{k+1})^3} f_{k+1} \\
+ \frac {(x - x_k) (x - x_{k+1})^2} {(x_k - x_{k+1})^2} f'_k + \frac {(x - x_{k+1}) (x - x_k)^2} {(x_{k+1} - x_k)^2} f'_{k+1}, k = 0, 1, ... , n-1
$$
